...
//private val ADD_NOTE_REQUEST_CODE = 2
//
...
//
//                    if (note != null) {
//                        // Make sure your insertNote function accepts three parameters
//                        viewModel.insertNote(note, null, imageUri)
//                    }
//                }
//            }
//
...
//
//                // Declare imageUri if not declared before
...
//            }
//        } else if (requestCode == ADD_NOTE_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
//            val note = data?.getSerializableExtra("note") as? Note
//            val imageUri = data?.getParcelableExtra<Uri>("imageUri")
//            note?.let {
//                viewModel.insertNote(it, null, imageUri)
//            }
//        }
//    }
//
